...
const Basics = () => {
  return (
    <div>
      ...
      <CodeBox className="mt-2 gap-2 grid grid-cols-2">
        <Springen.HoverFill className="flex p-4 gap-3 flex-1 rounded-lg">
          <img
...
<div>
  <Springen.HoverFill>light-button</Springen.HoverFill>
</div>
<Springen.HoverFill>light-button</Springen.HoverFill>
<Springen.HoverFill>light-button</Springen.HoverFill>`}</CodeBlock>
    </div>
  );
};
